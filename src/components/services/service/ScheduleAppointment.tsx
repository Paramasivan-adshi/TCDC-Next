...
const cta_content: CtaContentType = {
  ...
  title: "",
  sm_info: "We invite you to contact Town Center Dental Care today to schedule an appointment. We look forward to meeting you and helping you achieve optimal oral health!",
}
...
const ScheduleAppointment = () => {
  return (
    <>
      <section className="cta-area pos-rel pt-60 pb-30" style={{ backgroundImage: `url(${bg_img})` }}>
      ...
      <section className="bg-white pt-80 pb-50">
      <div className="mk-call-btn f-right mb-30 container">
